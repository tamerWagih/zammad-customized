class App.Ticket extends App.Model
  ...
  @configure_attributes = [
      ...
      { name: 'cc_user_ids',              display: __('CC'),           tag: 'user_autocompletion', multiple: true, null: true, relation: 'User', placeholder: __('Select agents or customers to CC'), item_class: 'multiple', filterPermissions: ['ticket.agent', 'ticket.customer'], disableCreateObject: true, screen: { create_middle: { shown: true } } },
    ]
