class App.Ticket extends App.Model
  ...
  @configure_attributes = [
      ...
      { name: 'cc_user_ids',              display: __('CC'),           tag: 'user_autocompletion', multiple: true, limit: 100, null: true, relation: 'User', edit: true, placeholder: __('Select users to CC'), source: "#{App.Config.get('api_path')}/tickets/ccs/search_users", screen: { create_middle: { shown: true } } },
    ]
