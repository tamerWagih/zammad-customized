class App.Ticket extends App.Model
  ...
  @configure_attributes = [
      ...
      { name: 'cc_user_ids',              display: __('CC'),           tag: 'cc_user_autocompletion', multiple: true, limit: 100, null: true, relation: 'User', edit: true, source: "#{App.Config.get('api_path')}/users/search", disableCreateObject: true, minLength: 0, nulloption: false, screen: { create_middle: { shown: true, item_class: 'column' } } },
    ]
